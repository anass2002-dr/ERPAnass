...
namespace ERP_Anass_backend.DTOs
{
    public class SaleDetailsDtos
    {
        ...
        // Constructor to map from SaleDetails model
        public SaleDetailsDtos(SaleDetails purchaseDetails)
        {
            IdSaleDetails = purchaseDetails.IdSaleDetails;
            ...
            IdSale = purchaseDetails.IdSale;

            // Map additional fields if they exist in the SaleDetails model
